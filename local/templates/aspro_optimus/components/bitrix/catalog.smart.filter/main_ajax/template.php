...
if($arResult["ITEMS"]){?>	<div class="bx_filter bx_filter_vertical">
...
/*				foreach($arResult["ITEMS"] as $key=>$arItem)
	...
	<script>
		...
		<?}?>
			...
			/** IVAN TROFIMOV JS*/
			function correct_filter(){
				var inputs = $('.bx_filter_section input.max-price[value!=""], .bx_filter_section input.min-price[value!=""], .bx_filter_parameters_box_container input:checked');
				//alert(inputs.size());
				$('.bx_filter_parameters_box').removeClass('filter_group_border');
				inputs.each(function(index, value) { 
   					$(this).closest('.bx_filter_parameters_box').addClass('filter_group_border'); 
				});
			};
			correct_filter();
						 $('.bx_filter_section input.max-price, .bx_filter_section input.min-price, .bx_filter_parameters_box_container input').change(function(){
							correct_filter();
						 });
			/**************////
